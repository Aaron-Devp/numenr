...
CREATE TABLE `detalles_ventas` (
  ...
  PRIMARY KEY (`id`),
  KEY `detalles_ventas_producto_id_fkey` (`producto_id`),
  KEY `detalles_ventas_venta_id_fkey` (`venta_id`),
  CONSTRAINT `detalles_ventas_producto_id_fkey` FOREIGN KEY (`producto_id`) REFERENCES `inventario` (`id`),
  CONSTRAINT `detalles_ventas_venta_id_fkey` FOREIGN KEY (`venta_id`) REFERENCES `ventas` (`id`)
